...
if (exists("snakemake")) {
  ...
  plot_width <- as.numeric(snakemake@wildcards[["plot_width"]])
  plot_height <- as.numeric(snakemake@wildcards[["plot_height"]])
} else {
...
ggsave(g, filename=fn_plot, width = plot_width, height = plot_height)
